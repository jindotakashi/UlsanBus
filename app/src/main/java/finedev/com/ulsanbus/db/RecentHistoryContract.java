 ...
 */
public class RecentHistoryContract {
    ...
    public static final class BusEntry implements BaseColumns {
        ...
        public static final String TABLE_NAME = "recent_history_bus";
    ...
    public static final class StationEntry implements BaseColumns {
        public static final String TABLE_NAME = "recent_history_station";
